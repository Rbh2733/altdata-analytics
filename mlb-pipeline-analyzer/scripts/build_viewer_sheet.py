...
per stint on the Hitters tab, all carrying the same season-level
...
Scoped to hitters only as of 2026-08-02: the Pitchers tab this workbook
used to carry is preserved at the `pitcher-work-2026-08-02` git tag, not
deleted, pending a properly validated pitcher WAR construction.
"""
...
def main():
    ...
    ws.append(["Player", "Position", "Readiness Score at Debut",
               "Rate Score (per 600 PA)", "Debut Date"])
    for r in debuted:
    ...
    # --- Tab 2: Hitters, full stint-level diagnostics -----------------------
    ...
    KEY_ROWS = [
        ...
        ("Workload", "Hitters",
         "Plain-English playing time for this one stint.", "e.g. '223 PA'."),
        ("wOBA", "Hitters",
        ...
        ("Replacement", "Hitters",
         ...
         "fill-in has some value.", "20.5 runs per 600 PA, published FanGraphs convention."),
        ...
        ("Season Readiness Score", "Hitters",
        ...
        ("Season Rate Score", "Hitters",
         "The same season restated per 600 PA, a full-season-equivalent "
    ...
    print(f"wrote {len(debuted)} players to the overview tab, "
          f"{n_h} hitter stint rows, to {out}")
